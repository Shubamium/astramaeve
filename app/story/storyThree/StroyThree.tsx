    ...
    <section className="story-three">
      <div className="decor-container">
        <motion.img
          ...
          src="/decors/story_circle.png"
          alt=""
          className="story_circle l "
        />
      </div>
      <div className="story-container">
        ...
        >
          ...
          <p>
            When not immersed in her latest research in the Amethyst Tower, she
            could be found teaching at Elvedere Academy or indulging in games in
            her messy room, much to the chagrin of her husband, Alvion, and the
            laughter of their daughter Ciel, the only other residents of the
            tower.
          </p>
          <a
            href="https://sites.google.com/view/theamethystarchives/home-page"
            target="_blank"
