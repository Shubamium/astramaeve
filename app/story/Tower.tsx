...
const chapters = [
  ...
  `
	...
	The constant rearrangement, prompted by Astra's penchant for extreme magical exploration, has given rise to sporadic explosions and Alvion's perennial cries of dismay. Lamenting his fate each time, forced to clean the aftermath of his wife's experiments.
	`,
  `
    ...
    <section className="tower" id="tower">
      <div className="decor-circle ni">
        <motion.img
          ...
          src="/decors/circle_basic.png"
          alt=""
          className="circle-dec"
        />
      </div>
      <div className="content">
        ...
        <div className="controls">
          <button className="btn btn-ctrl" onClick={prev}>
            <FaArrowLeft />
          </button>
