    ...
    <main id="page_story">
      ...
      <section className="general-info">
        <article className="about" id="about">
          <div className="about-nav">
            <Link href={"#"} className="btn btn-about-nav">
              ✦ STORY
            </Link>
            <Link href={"#tower"} className="btn btn-about-nav alt">
              {" "}
              ✦ AMETHYST TOWER
            </Link>
            <Link href={"#salvere"} className="btn btn-about-nav alt">
              {" "}
              ✦ SALVERE
            </Link>
          </div>
      ...
      <section className="companionship">
        <figure className="companions">
          <img
            src="./decors/companionship_decor.png"
            alt=""
            className="companion-decor"
          />
          <img src="./arts/talking.gif" alt="" className="companion-gif" />
        </figure>
        <article>
          <p>
            Yet Astra was different. Despite the vastness of her existence, she{" "}
            <strong>yearned for companionship</strong> in the cosmos. Her life
            as a star felt mundane and pitiful, with her only solace being the
            observation of life on distant worlds. 
          </p>
        </article>
      </section>
      ...
      <section className="story_two">
        <div className="content">
          <h2>◈ Rebirth ◈</h2>
          <p>
            Unexpectedly, the end of her celestial existence ushered in a new
            opportunity and a new life, now named Astralias, a member of the{" "}
            <strong>Noble Mæve Clan</strong> in the{" "}
            <strong>kingdom of Salvere</strong>. 
          </p>
          <p>
            In her new environment, Astra thrived. The vibrant colors, the
            bustling life, and the constant interactions with others fulfilled
            her long-standing desire for companionship. The voices of distant
            stars in her mind criticized her happiness in being reincarnated as
            an inferior being, but Astra remained content. 
          </p>
        </div>
      </section>
      ...
      <section className="childhood">
        <article className="panel left">
          ...
          <p>
            Her childhood passed joyfully with a loving family, her grandfather
            a respected figure heading the Council. 
          </p>
          <p>
            However, challenges surfaced when Astra turned 50:{" "}
            <u>her star powers began to manifest</u>, and the accumulation of
            mana in her body accelerated.{" "}
          </p>
        </article>
        <figure>
          <img
            src="./arts/chibi_childhood.png"
            alt=""
            className="astra-smile"
          />
        </figure>
        <article className="panel right">
          ...
          <p>
            The memories of billions of years brought headaches, and the immense
            mana concentration took a toll on her young body,
            <strong> confining her to bed for several years.</strong>  
          </p>
          <p>
            Determined to overcome these challenges, Astra embarked on a journey
            to master the energy within her, delving into{" "}
